					...
					unsigned int cmd, unsigned long arg)
{
	...
	printk("sizeofstruct:%d, _IOC_SIZE(IOCTL_VALSET):%d, _IOC_SIZE(IOCTOL_VALGET):%d, _IOC_SIZEBITS:%d\n", sizeof(struct ioctl_cmd), _IOC_SIZE(IOCTL_VALSET), _IOC_SIZE(IOCTL_VALGET), _IOC_SIZEBITS);
	switch (cmd) {
		case IOCTL_VALSET:
			...
			printk("SET_IOCTL_cmd.reg %u (%s)\n", data.reg, __func__);
			printk("SET_IOCTL_cmd.val %u (%s)\n", data.val, __func__);
		...
		case IOCTL_VALGET:
			...
			if ( copy_to_user((int __user *)arg, &data, sizeof(data)) ) {
				...
				goto done;
                        ...
                        printk("GET_IOCTL_cmd.reg %u (%s)\n", data.reg, __func__);
                        printk("GET_IOCTL_cmd.val %u (%s)\n", data.val, __func__);
